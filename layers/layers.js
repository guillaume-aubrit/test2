...
lyr_AuvergneHabitat_2.set('fieldImages', {'Nom ou référence de l\'opération': 'TextEdit', 'Segmentation': 'TextEdit', 'Date d\'OS Travaux': 'TextEdit', 'Typologie d\'habitat': 'TextEdit', 'Nombre d\'étage maximum (R+..)': 'TextEdit', 'Nombre de logements': 'Range', 'Année de construction': 'Range', 'Nouvelle étiquette DPE 2020 (si connue)': 'TextEdit', 'Mode de chauffage': 'TextEdit', 'Energie de chauffage': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'Etiquette': '', });
lyr_AURA_Departements_1.set('fieldLabels', {'CODE': 'no label', 'NOM': 'header label', 'PSDC': 'no label', 'MENAGES': 'no label', 'NBLOG': 'no label', 'CODEREG': 'no label', 'SUPERFICIE': 'no label', 'RP_FouG': 'no label', });
lyr_AuvergneHabitat_2.set('fieldLabels', {'Nom ou référence de l\'opération': 'inline label', 'Segmentation': 'inline label', 'Date d\'OS Travaux': 'inline label', 'Typologie d\'habitat': 'inline label', 'Nombre d\'étage maximum (R+..)': 'header label', 'Nombre de logements': 'inline label', 'Année de construction': 'inline label', 'Nouvelle étiquette DPE 2020 (si connue)': 'inline label', 'Mode de chauffage': 'inline label', 'Energie de chauffage': 'inline label', 'latitude': 'inline label', 'longitude': 'inline label', 'Etiquette': 'inline label', });
